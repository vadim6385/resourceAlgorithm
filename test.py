...
def main():
    ...
    users = [
        ...
        User(UserType.PREMIUM, demand=250, start_time=5, end_time=20),
        User(UserType.ENTERPRISE, demand=500, min_bandwidth=50, start_time=10, end_time=20),
        User(UserType.REGULAR, demand=400, start_time=0, end_time=5),
        User(UserType.PREMIUM, demand=300, start_time=5, end_time=10),
        ...
        User(UserType.PREMIUM, demand=300, start_time=0, end_time=25),
        User(UserType.ENTERPRISE, demand=900, min_bandwidth=50, start_time=0, end_time=25),
    ]
